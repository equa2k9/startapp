...
(function (e) {
    ...
    e.Poshytip.prototype = {init: function () {
            ...
            if (this.opts.showOn != "none") {
                this.$elm.bind({"mouseenter.poshytip": e.proxy(this.mouseenter, this), "mouseleave.poshytip": e.proxy(this.mouseleave, this)});
                switch (this.opts.showOn) {
                    case"hover":
                        ...
                        break;
                    case"focus":
                        this.$elm.bind({"focus.poshytip": e.proxy(this.show, this), "blur.poshytip": e.proxy(this.hide, this)});
                        break
                }
            }
            ...
            if (h && this.opts.refreshAniDuration) {
                ...
                var p = this;
                this.$tip.css(k).animate({left: this.pos.l, top: this.pos.t}, this.opts.refreshAniDuration, function () {
