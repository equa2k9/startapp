(function (a) {
    ...
    b.detectSubsampling = function (a) {
        ...
        while (h > f)
            i = e[(h - 1) * 4 + 3], i === 0 ? g = h : f = h, h = g + f >> 1;
        return h / b
        ...
        while (m < g) {
            n = m + j > g ? g - m : j, o = 0;
            while (o < f)
                p = o + j > f ? f - o : j, l.clearRect(0, 0, j, j), l.drawImage(a, -o, -m), h.drawImage(k, 0, 0, p, n, Math.floor(o * d / f), Math.floor(m * e / g / i), Math.ceil(p * d / f), Math.ceil(n * e / g / i)), o += j;
            m += j
        }
        h.restore(), k = l = null
